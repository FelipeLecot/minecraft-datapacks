...
# Armor
give @s iron_helmet[enchantments={protection:3}]
give @s iron_chestplate[enchantments={protection:3}]
give @s iron_leggings[enchantments={protection:3}]
give @s iron_boots[enchantments={protection:3}]
